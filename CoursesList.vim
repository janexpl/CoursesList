...
set pyxversion=2
set ruler
set runtimepath=~/.vim,~/.vim/plugged/awesome-vim-colorschemes/,~/.vim/plugged/nerdcommenter/,~/.vim/plugged/youcompleteme/,~/.vim/plugged/vim-colors-solarized/,~/.vim/plugged/deoplete-go/,~/.vim/pack/plugins/start/vim-go,~/.vim/pack/plugins/start/nerdtree,~/.vim/pack/plugins/start/nerdcommenter,/Applications/MacVim.app/Contents/Resources/vim/vimfiles,/Applications/MacVim.app/Contents/Resources/vim/runtime,/Applications/MacVim.app/Contents/Resources/vim/vimfiles/after,~/.vim/plugged/awesome-vim-colorschemes/after,~/.vim/after
set secure
set shiftwidth=3
...
tabnew
tabrewind
edit go/src/github.com/janexpl/CoursesList/controllers/certificates.go
...
exe 'vert 2resize ' . ((&columns * 168 + 101) / 203)
argglobal
enew
file NERD_tree_1
let s:cpo_save=&cpo
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 272 - ((21 * winheight(0) + 24) / 49)
...
exe 'vert 2resize ' . ((&columns * 168 + 101) / 203)
tabnext
edit go/src/github.com/janexpl/CoursesList/templates/companies/update.gohtml
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 106 - ((3 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
106
...
argglobal
terminal ++curwin ++cols=203 ++rows=24 
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 26 - ((9 * winheight(0) + 12) / 24)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
26
...
tabnext 2
set stal=1
badd +87 go/src/github.com/janexpl/CoursesList/controllers/companies.go
badd +1 .vimrc
badd +190 go/src/github.com/janexpl/CoursesList/models/company.go
badd +70 go/src/github.com/janexpl/CoursesList/templates/students/update.gohtml
badd +116 go/src/github.com/janexpl/CoursesList/templates/companies/update.gohtml
badd +84 go/src/github.com/janexpl/CoursesList/templates/students/show.gohtml
badd +1 go/src/github.com/janexpl/CoursesList/certificates/handlers.go
badd +1 go/src/github.com/janexpl/CoursesList/templates/certificates/certificates.gohtml
badd +0 go/src/github.com/janexpl/CoursesList/controllers/certificates.go
